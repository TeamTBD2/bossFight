...
locar.on("gpsupdate", (pos, distMoved) => {
  if (firstLocation) {
    ...
    const boxProps = [
      { latDis: 0.00005, lonDis: 0, colour: 0xff0000 },
      { latDis: -0.00005, lonDis: 0, colour: 0xffff00 },
      { latDis: 0, lonDis: -0.00005, colour: 0x00ffff },
      { latDis: 0, lonDis: 0.00005, colour: 0x00ff00 }
    ];
